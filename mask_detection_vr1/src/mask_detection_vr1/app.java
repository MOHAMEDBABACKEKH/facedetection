	...
	public static void main(String[] args) {
		...
		*/
		...
		CascadeClassifier cascadeFaceClassifier = new CascadeClassifier(
				"D:\\apks\\OpenCv3.0\\opencv\\build\\etc\\haarcascades\\haarcascade_frontalface_default.xml");
		CascadeClassifier cascadeEyeClassifier = new CascadeClassifier(
				"D:\\apks\\OpenCv3.0\\opencv\\build\\etc\\haarcascades\\haarcascade_eye.xml");
		
		CascadeClassifier cascadeNoseClassifier = new CascadeClassifier(
				"D:\\apks\\OpenCv3.0\\opencv\\build\\etc\\haarcascades\\haarcascade_mcs_nose.xml");
	    CascadeClassifier cascadeMouthClassifier = new CascadeClassifier("D:\\apks\\OpenCv3.0\\opencv\\build\\etc\\haarcascades\\haarcascade_mcs_mouth.xml"); //haarcascade_mcs_mouth on 2.4.11
			...
			while (true) {		
			   ...
			   MatOfRect mouth = new MatOfRect();
				...
				for (Rect rect : mouth.toArray()) {
					Imgproc.putText(frameCapture, "mouth", new Point(rect.x,rect.y-5), 1, 2, new Scalar(0,0,255));
					Imgproc.rectangle(frameCapture, new Point(rect.x, rect.y), new Point(rect.x + rect.width, rect.y + rect.height),
