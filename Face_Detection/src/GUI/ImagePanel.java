...
public class ImagePanel extends JPanel{
	...
	public ImagePanel() {
		...
		setBorder(BorderFactory.createEmptyBorder(Constants.Constants.IMAGE_LABEL_BORDER,Constants.Constants.IMAGE_LABEL_BORDER,Constants.Constants.IMAGE_LABEL_BORDER,Constants.Constants.IMAGE_LABEL_BORDER));
